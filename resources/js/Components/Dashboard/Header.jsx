...
export default function Header({user}){
    ...
    // Effect to add click event listener to close menu when clicking outside
    useEffect(() => {
    ...
    return (
        ...
        <div className="me-5 lg:me-0 lg:hidden" onClick={toggleMobileMenu}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6 text-dark dark:text-white cursor-pointer"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <div className="me-5 lg:me-0 lg:hidden">
            ...
            {/* Mobile menu */}
            <nav ref={menuRef} className={`fixed inset-0 z-50 bg-white dark:bg-gray-800 w-full max-w-[70%] pt-2 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="p-4">
                    {/* Cross icon to close the menu */}
                    <div className="flex justify-end">
                        <button className="cursor-pointer" onClick={closeMobileMenu}>
                            <svg className="w-6 h-6 text-gray-600 hover:text-gray-900 dark:text-gray-100 dark:hover:text-gray-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    name="Dashboard"
                    icon={
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="flex-shrink-0 size-5">
          ...
          <div className="w-full flex items-center justify-end ms-auto sm:justify-between sm:gap-x-3 sm:order-3">
            ...
            <Dropdown>
                <Dropdown.Trigger>
                    <img
                        className="inline-block h-[2.375rem] w-[2.375rem] rounded-full ring-2 ring-primary  cursor-pointer"
